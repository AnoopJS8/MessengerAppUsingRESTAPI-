...
import com.anoop.messenger.resources.service.ProfileService;
...
public class ProfileResource {
	...
	@GET
	@Path("/{profileName}")
	public Profile getProfile(@PathParam("profileName") String profileName){ //Jersey automatically changes it to Long from the String param
